...
- **Limits**: each UDP listener keeps at most 1024 client sessions (new sources are dropped while it is full), each TCP listener at most 4096 concurrent connections, and a TLS-terminating stream allows 10 seconds for the handshake.
